...
struct ProfileViewDriver1: View {
                ...
                VStack {
                    VStack {
                        HStack {
                            ...
                            Text("CHF 7.50")+Text(" (estimated price)").foregroundColor(.gray)
                        }.position(x: 180, y: 25)
                        HStack {
                    ...
                    VStack{
                        HStack {
                            ...
                            Text("I love F1! But don't worry,\nI'll stick to the speed limit...")
                        }.position(x: 181, y: 40)
...
struct ProfileViewDriver1_Previews: PreviewProvider {
