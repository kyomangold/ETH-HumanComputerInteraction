...
struct ProfileViewDriver5: View {
                ...
                VStack {
                    VStack {
                        HStack {
                            ...
                            Text("CHF 9.30")+Text(" (estimated price)").foregroundColor(.gray)
                        }.position(x: 180, y: 25)
                        HStack {
                    ...
                    VStack{
                        ...
                        HStack {
                            ...
                            Text("Wrecked by Imagine Dragons")
                        }.position(x: 189, y: 20)
                        HStack {
...
struct ProfileViewDriver5_Previews: PreviewProvider {
